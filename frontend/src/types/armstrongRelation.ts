...
export const MOCK_ARMSTRONG_RELATION: ArmstrongRelation = {
    ...
    exampleRows: [
        ...
        { maxSet: [ 1,3 ], isNegative: false, state: ExampleState.Accepted, values: [ 'tt0115392', 'Titanic', '1979', '85', 'Drama+Romance' ] },
        { maxSet: [ 1,4 ], isNegative: false, state: ExampleState.Rejected, values: [ 'tt0120338', 'Titanic', '1996', '87', 'Action+Drama+History' ] },
        { maxSet: [ 3 ], isNegative: true, state: ExampleState.New, values: [ 'tt0143942', 'S.O.S. Titanic', '1997', '85', 'History' ] },
    ],
...
export const MOCK_LATTICE: Lattice = {
