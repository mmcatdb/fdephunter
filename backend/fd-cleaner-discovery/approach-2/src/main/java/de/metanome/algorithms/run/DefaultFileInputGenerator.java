 ...
 */
package de.metanome.algorithms.run;
...
/**
 * Generator for {@link de.metanome.algorithm_integration.input.RelationalInput}s based on file files. The setting holds
 * all parameters to construct new {@link de.metanome.algorithm_integration.input.RelationalInput}s. To adapt the
 * parameters you have to adapt the setting.
 *
...
public class DefaultFileInputGenerator implements FileInputGenerator {
    ...
    /**
     * Creates a DefaultFileInputGenerator with default settings. The default setting is used to construct a new
     * {@link de.metanome.algorithm_integration.input.RelationalInput}.
     *
